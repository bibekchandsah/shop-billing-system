...
export const getBillHtml = (
  ...
  const renderCopyHtml = () => `
    <div class="print-scale-wrap" id="pdf-content-wrapper">
      <div class="header">
        <h1>${billTitle}</h1>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body {
      ...
      color: #000;
      background: #fff;
      padding: ${isPdf ? '0' : '2cm 2.5cm'};
    }
    .print-scale-wrap {
      transform: scale(${wrapperScale});
      transform-origin: top left;
      width: ${isPdf ? '210mm' : `calc(100% / ${wrapperScale})`};
      min-height: ${isPdf ? '297mm' : `calc(235mm / ${wrapperScale})`};
      display: flex;
      flex-direction: column;
      position: relative;
      background: white;
      padding: ${isPdf ? '2cm 2.5cm' : '0'};
    }
    ...
    table { width: 100%; border-collapse: collapse; margin-bottom: 0.75em; font-size: 0.95em; flex-grow: 1; border: 1px solid #000; }
    thead th {
